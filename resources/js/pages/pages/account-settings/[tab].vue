...
definePage({
  ...
  path: '/pages/account-settings/:tab',
  meta: {
...
// ⛔️ ¡ASEGÚRATE DE QUE LA LLAMADA DUPLICADA HAYA SIDO BORRADA DE AQUÍ!
// (La línea "definePage({ meta: { navActiveLink: 'pages-account-settings-tab' } })"
// debe ser eliminada de esta parte).
</script>
